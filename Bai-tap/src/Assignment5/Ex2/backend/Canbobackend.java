package Assignment5.Ex2.backend;

import java.util.ArrayList;
import java.util.List;
import java.util.Scanner;

import Assignment5.Ex2.entity.Canbo;
import Assignment5.Ex2.entity.Congnhan;
import Assignment5.Ex2.entity.Kysu;
import Assignment5.Ex2.entity.Nhanvien;
...
public class Canbobackend {
	...
	public void Themcanbo() {
		Assignment5.Ex2.entity.Canbo doituong = new Canbo();            // Class cha
